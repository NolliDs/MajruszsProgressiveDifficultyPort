...
public class EnderiumShardLocator extends Item {
	...
	public static class Client {
		public static float getShardDistance( ItemStack itemStack, @Nullable ClientLevel level, @Nullable LivingEntity entity, int seed ) {
			...
			net.minecraft.world.item.component.CustomData customData = itemStack.getOrDefault( net.minecraft.core.component.DataComponents.CUSTOM_DATA, net.minecraft.world.item.component.CustomData.EMPTY );
			net.minecraft.nbt.CompoundTag tag = customData.copyTag();
			Serializables.modify( itemInfo, tag, info->{
				if( info.position != null && !EnderiumShardLocator.isOre( level, info.position ) ) {
					info.position = null;
				}
